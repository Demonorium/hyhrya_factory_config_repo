...
if __name__ == "__main__":
    to_download_mods = [
        ['https://mediafilez.forgecdn.net/files/7498/883/CustomMachinery-forge-1.20.1-0.10.8.jar', "CustomMachinery-forge-1.20.1-0.10.8.jar", 'server'],
    ]

    if os.path.exists('mods/Custom-Machinery-Mekanism-1.3.6.jar.disabled'):
        print('Реактивация мода Custom-Machinery-Mekanism-1.3.6.jar')
        os.rename('mods/Custom-Machinery-Mekanism-1.3.6.jar.disabled', 'mods/Custom-Machinery-Mekanism-1.3.6.jar')
        
    if os.path.exists('mods/CustomMachinery-forge-1.20.1-0.10.7.jar.disabled'):
        print('Удаленние мода CustomMachinery-forge-1.20.1-0.10.7.jar.disabled')
        os.remove('mods/CustomMachinery-forge-1.20.1-0.10.7.jar.disabled')
    
    print('Установка мода hyhryacasingmod-1.0-SNAPSHOT (Возможность накрывать кабели)')
    shutil.copy('./update/hyhrya_factory_config_repo-master/custom_mods/hyhryacasingmod-1.0-SNAPSHOT.jar', 'mods/hyhryacasingmod-1.0-SNAPSHOT.jar')
