...
ServerEvents.recipes(event => {
  ...
  event.replaceInput({id: "thermal:augments/upgrade_augment_1"}, "glass", "mekanism:advanced_control_circuit")

  event.replaceInput({id: "thermal:augments/upgrade_augment_1"}, "glass", "mekanism:advanced_control_circuit")
  event.replaceInput({id: "thermal:augments/upgrade_augment_2"}, "thermal:signalum_gear", "mekanism:elite_control_circuit")
