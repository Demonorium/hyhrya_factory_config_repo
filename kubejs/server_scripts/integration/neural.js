...
ServerEvents.recipes(event => {
    ...
    event.replaceInput({id: "hostilenetworks:loot_fabricator"}, "obsidian", "ae2:molecular_assembler")
    event.replaceInput({id: "hostilenetworks:loot_fabricator"}, "diamond", "pncepcb:high_power_finished_pcb")
